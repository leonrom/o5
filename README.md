...
Библиотека имеет модульную структуру, состоящую из ядра,- библиотекообразующего скрипта o5common.js и расширяемого набора функциональных модулей, что позволяет авторам страниц подключать (а также и самостоятельно разрабатывать) лишь необходимый функционал.
